                         ...
                         <tr>
                          ...
                          <tr>
                           ...
                           <td> <input name="arquivo" type="file" size="50"><BR>          
                            <input name="cod" type="hidden" id="cod" value="<?php echo $row_Recordset1['codCLIENTE']; ?>"> <br>
                            Atual:<br> 
                            <?php if($row_Recordset1['imgUSUARIO'] != 'pagsclientes/') : ?>
                            <div id="imgUser"><img src="<?php echo $row_Recordset1['imgUSUARIO']; ?>"></div>
                          <?php else: ?>
                          <div id="imgUser"><br><i>Nenhuma imagem cadastrada.</i></div>
                        <?php endif; ?>
                        <BR>
                        </td>
                      </tr>
