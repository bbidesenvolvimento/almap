...
// Carausel
	...
	$('.carousel').uCarousel({show:1,buttonClass:'car-button', pageStep:1})
// Slider
	$('.pro_slider')._TMS({
		show:0,
		pauseOnHover:false,
...
$(function(){
	...
	$('.slider')._TMS({
		...
		$('.page5-box1').hover(
				function(){$(this).find('.page5-box2').stop().animate({left:'0px'}, 400, 'easeOutBack')},
				function(){$(this).find('.page5-box2').stop().animate({left:'-310px'}, 400, 'easeInBack')}
			)
});
