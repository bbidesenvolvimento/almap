...
// Imagem foi enviada, então a move para o diretório desejado
	...
	$string_sql = "INSERT INTO clientes (nomeCLIENTE, loginCLIENTE, senhaCLIENTE, usuarioTABLEAU, imgUSUARIO) VALUES ('$cliente','$login','$senha','$usuarioTB','$caminhoimg')"; //String com consulta SQL da inserção
	
	mysql_query($string_sql,$conexao); //Realiza a consulta
	
	if(mysql_affected_rows() == 1){ //verifica se foi afetada alguma linha, nesse caso inserida alguma linha
		echo "<p>Cadastro feito com sucesso</p>";
		echo '<a href="cadastraclientes.php">Voltar para formulário de cadastro de clientes</a>'; //Apenas um link para retornar para o formulário de cadastro
		echo '<p><a href="verclientes.php">Ver Clientes cadastrados</a></p>'; //Apenas um link para retornar para o formulário de cadastro
	} else {
