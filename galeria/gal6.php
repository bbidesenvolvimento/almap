...
<html lang="en">
<head>
  	<title>BBI || Galeria</title>
  	<meta charset="utf-8">
    <meta name="description" content="BBI. Information to empower people">
    <meta name="keywords" content="Business Intelligence; Infográficos; Gestão de E-commerce; Conversões de banco de dados; gestão; BI; inteligência para negócios; Behemoth; BBI">
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/pt_BR/all.js#xfbml=1&appId=388857924517709";
		...
		<a class="logo" href="index.html">BBI</a>
            <nav>
                <ul class="sf-menu">
                    ...
                    <li class="last1"><a href="#">Comercialização</a></li>
                    </ul>
                    </li>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
        ...
        <div class="grid_5">
        <a href="gal4.html" class="pro_btn pro_prev"><span></span>Anterior</a>
        <a href="#" class="pro_btn pro_next">Próximo<span></span></a>
        </div>
			<div class="grid_24">
            <iframe scrolling="no" src="<?php echo get_trusted_url($user,$server,'views/Renavam/RENAVAM');?>"> </iframe>
            </div>
             </div>
             <div class="clear"></div>
             <div id="textgq">
             <img src="../images/icons/flag_272.png" alt="">
             Needing it in English?
              <a href="mailto:empower-me@bbi.net.br">Just ask us</a>. It is free.
              </div>
              <article class="grid_24">
                <div class="grid_24">
                <iframe src="http://www.facebook.com/plugins/comments.php?href=https://www.bbi.net.br/galeria/gal5.html&permalink=1" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:130px; height:16px;" allowTransparency="true"></iframe>  
                  </div>
                  <div class="grid_24">
