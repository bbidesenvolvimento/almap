...
// Imagem foi enviada, então a move para o diretório desejado
	...
	$clientemaster = $_POST["clientemaster"]; 
	$loginmaster = $_POST["loginmaster"];
	$senhamaster = $_POST["senhamaster"];
	$caminhoimg = $diretorio . $arquivo['name'];
	
	$string_sql = "INSERT INTO usuariomaster (nomeMaster, loginMaster, senhaMaster, imgMaster) VALUES ('$clientemaster','$loginmaster','$senhamaster','$caminhoimg')"; //String com consulta SQL da inserção
