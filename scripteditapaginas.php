        ...
        <div class="main">
          ...
          <div class="container_24 p42">  
           <div class="pro_wrapper">
            <h5 class="main_h5">Edição de Páginas</h5>
          </div>
          <div class="pro_wrapper">
           <div id="areaa">
            <form method="POST" action="editapagina.php" name="form" >
               ...
               <input type="submit" class="pro_btn" value="Salvar"><a href="adm.php?tab=5" class="pro_btn pro_back"><span></span>Cancelar</a>
             </form>
