...
$query_Recordset1 = "SELECT * FROM clientes LEFT JOIN usuariomaster ON clientes.codMaster = usuariomaster.codMaster order by nomeMaster ASC";
$Recordset1 = mysql_query($query_Recordset1, $conexao) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
...
<body id="page4"> 
  ...
  <section id="content"> 
    <h5 class="main_h5">Exibe, edita ou remove logins</h5>
