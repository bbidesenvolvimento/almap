...
// Imagem foi enviada, então a move para o diretório desejado
	...
	$string_sql = "UPDATE clientes SET nomeCLIENTE='$cliente' , loginCLIENTE='$login' , senhaCLIENTE='$senha' , usuarioTABLEAU='$usuarioTB' , imgUSUARIO='$caminhoimg' , codMaster='$codMaster' WHERE codCLIENTE='$cod'";
