...
<!--==============================header=================================-->   
   <header>
    ...
    <div class="bg2"> 
        ...
        <h5 class="main_h5"><a href="adm.php">Administração:</a> Exibe, edita ou remove clientes master</h5>
        </div>
              <div class="pro_wrapper">
                 <div id="areaa">
                 ...
                 <td width="230"><strong>Senha</strong></td>
                 ...
                 <?php do { ?>
                  <tr>
                    ...
                    <td><?php echo $row_Recordset1['loginMaster']; ?></td>
                    <td><?php echo $row_Recordset1['senhaMaster']; ?></td>
                    
                    <td><a href="scripteditaclientesmaster.php?cod=<?php echo $row_Recordset1['codMaster']; ?>">Editar</a></td>
                    <td><a href="scriptremoveclientesmaster.php?cod=<?php echo $row_Recordset1['codMaster']; ?>">Remover</a></td>
                  </tr>
