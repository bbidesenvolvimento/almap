...
if (isset($_GET['cod_cliente'])) {
  $colname_Recordset1 = $_GET['cod_cliente'];
}
mysql_select_db($database_conexao, $conexao);
$query_Recordset1 = sprintf("SELECT * FROM paginas INNER JOIN clientes ON paginas.cod_cliente = clientes.codCLIENTE WHERE paginas.cod_cliente = %s", GetSQLValueString($colname_Recordset1, "int"));
              ...
              <div class="pro_wrapper">
                 ...
                 <?php do { ?>
                  <tr>
                    ...
                    <td><a href="scripteditapaginas2.php?cod=<?php echo $row_Recordset1['cod_pagina']; ?>">Editar</a></td>
                    <td><a href="scriptremovepaginas2.php?cod=<?php echo $row_Recordset1['cod_pagina']; ?>">Remover</a></td>
                  </tr>
