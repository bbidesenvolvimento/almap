...
<html lang="en">
<head>
  	<title>BBI || Login Services</title>
  	<meta charset="utf-8">
...
<!--==============================header=================================-->   
   <header>
    ...
    <div class="bg2"> 
        ...
        <h5 class="main_h5">Área de redefinição de senha. Usuário Comum.</h5>
        </div>
              <div class="pro_wrapper">
                 <div id="areaa">
                   <form name="form1" method="post" action="redefineusuario.php">
                    <table width="435">
                    <tr>
                    ...
                    <tr>
                    <td><label for="senhaantiga">Sua senha atual</label></td>
                    <td><input type="text" name="senhaantiga" id="senhaantiga"></td>
                     </tr>
                     <tr>
                    <td><label for="senhanova">Digite a nova senha</label></td>
                    <td><input type="text" name="senhanova" id="senhanova"></td>
                    </tr>
                    <tr>
                    <td>&nbsp;</td>
